...
CREATE TABLE `artikel` (
  ...
  `bezeichnung_artikel` varchar(300) COLLATE latin1_german1_ci NOT NULL,
  `hoehe` decimal(8,2) NOT NULL,
  `breite` decimal(8,2) NOT NULL,
  `tiefe` decimal(8,2) DEFAULT NULL,
  `gewicht` decimal(8,2) NOT NULL,
  `preis` decimal(8,2) NOT NULL,
  `status` varchar(1) COLLATE latin1_german1_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_german1_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-04-26 15:04:01
