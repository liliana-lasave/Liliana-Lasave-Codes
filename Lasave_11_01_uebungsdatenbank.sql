...
--
-- Host: localhost    Database: lasave_11_uebungsdatenbank
-- ------------------------------------------------------
...
CREATE TABLE `artikelaktuell` (
  `artikelid` int NOT NULL,
  `bezeichnung` varchar(255) CHARACTER SET latin1 COLLATE latin1_german1_ci DEFAULT NULL,
  `hoehe` decimal(8,2) NOT NULL,
  `breite` decimal(8,2) NOT NULL,
  `tiefe` decimal(8,2) DEFAULT NULL,
  `gewicht` decimal(8,2) NOT NULL,
  `preis` decimal(8,2) NOT NULL,
  `status` varchar(300) CHARACTER SET latin1 COLLATE latin1_german1_ci DEFAULT NULL,
  PRIMARY KEY (`artikelid`),
...
INSERT INTO `kreditinstitut` VALUES (1,12345678,'Test Bank Berlin',10789,'Berlin');
...
INSERT INTO `kreditinstitutneu` VALUES (1,1,12345678,'Test Bank Berlin',10789,'Berlin');
...
--
-- Temporary view structure for view `v_mitarbeiterbonus`
--

DROP TABLE IF EXISTS `v_mitarbeiterbonus`;
/*!50001 DROP VIEW IF EXISTS `v_mitarbeiterbonus`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_mitarbeiterbonus` AS SELECT 
 1 AS `name`,
 1 AS `vorname`,
 1 AS `bonuszahlung`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `v_praemie`
--

DROP TABLE IF EXISTS `v_praemie`;
/*!50001 DROP VIEW IF EXISTS `v_praemie`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_praemie` AS SELECT 
 1 AS `name`,
 1 AS `vorname`,
 1 AS `praemie`,
 1 AS `grund`*/;
...
--
-- Temporary view structure for view `v_urlaub`
--

DROP TABLE IF EXISTS `v_urlaub`;
/*!50001 DROP VIEW IF EXISTS `v_urlaub`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_urlaub` AS SELECT 
 1 AS `name`,
 1 AS `vorname`,
 1 AS `urlaubstage`,
 1 AS `urlaubgenommen`*/;
...
--
-- Final view structure for view `v_mitarbeiterbonus`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_mitarbeiterbonus` AS select `mitarbeiter`.`name` AS `name`,`mitarbeiter`.`vorname` AS `vorname`,`bonus`.`bonuszahlung` AS `bonuszahlung` from (`mitarbeiter` join `bonus` on((`mitarbeiter`.`mitarbeiterid` = `bonus`.`mitarbeiterid`))) order by `bonus`.`bonuszahlung` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_praemie`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_praemie` AS select `mitarbeiter`.`name` AS `name`,`mitarbeiter`.`vorname` AS `vorname`,`sachpraemie`.`praemie` AS `praemie`,`sachpraemie`.`grund` AS `grund` from (`mitarbeiter` join `sachpraemie` on((`mitarbeiter`.`mitarbeiterid` = `sachpraemie`.`mitarbeiterid`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_urlaub`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_urlaub` AS select `mitarbeiter`.`name` AS `name`,`mitarbeiter`.`vorname` AS `vorname`,`mitarbeiter`.`urlaubstage` AS `urlaubstage`,`mitarbeiter`.`urlaubgenommen` AS `urlaubgenommen` from `mitarbeiter` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-05-05 21:26:43
